...
public class DBSistemaGestion extends SQLiteOpenHelper {
    ...
    public ContentValues generarValoresBodega(Bodega bodega,boolean modificacion){
        ContentValues content= new ContentValues();
        if(!modificacion){content.put(Bodega.FIELD_idbodega,bodega.getIdbodega());}
    ...
    public boolean modificarImagenesProducto(String id_producto,String path, int posicion) {
        ...
        switch (posicion){
            case 0:contentValues.put(IVInventario.FIELD_img1, path);break;
            case 1:contentValues.put(IVInventario.FIELD_img2, path);break;
            case 2:contentValues.put(IVInventario.FIELD_img3, path);break;
        }
