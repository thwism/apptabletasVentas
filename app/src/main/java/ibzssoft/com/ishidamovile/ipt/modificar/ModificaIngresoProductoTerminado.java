package ibzssoft.com.ishidamovile.ipt.modificar;
...
public class ModificaIngresoProductoTerminado extends AppCompatActivity implements View.OnClickListener{
    /*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifica_ipt);
    ...
    public void cargarDatos(String id_trans) {
        ...
        if (cursor.moveToFirst()) {
            ...
            if (cursor1.moveToFirst()) {
                ...
                ExtraerConfiguraciones ext = new ExtraerConfiguraciones(ModificaIngresoProductoTerminado.this);
    ...
    class AutoCompleteProductoSelected extends CursorAdapter implements AdapterView.OnItemClickListener {
        ...
        public AutoCompleteProductoSelected(Context context, int row) {
            super(ModificaIngresoProductoTerminado.this, null);
    ...
    */
    ...
    public boolean guardarTrans() {
        ...
        alertDialogBuilder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface arg0, int arg1) {
                DBSistemaGestion helper = new DBSistemaGestion(ModificaIngresoProductoTerminado.this);
    ...
    class GuardarDetallesTask extends AsyncTask<String, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = new ProgressDialog(ModificaIngresoProductoTerminado.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(ModificaIngresoProductoTerminado.this, MainActivity.class);
