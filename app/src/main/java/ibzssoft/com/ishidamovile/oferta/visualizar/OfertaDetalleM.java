...
public class OfertaDetalleM extends AppCompatActivity {
    private TextView fe,he,bod,trans,precio,vendedor,cedula,nombres,direccion,telefono,mail,cli_obs,atencion, te, vl, fp,obs,subtotal_12,subtotal_0,subtotal_total,total_iva,total_trans,fm,fenvio,estado,alterno,referenciaTittle,referencia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oferta_detallem);
    ...
    public void cargarPreferencias(){
        ExtraerConfiguraciones ext = new ExtraerConfiguraciones(OfertaDetalleM.this);
    ...
    public void agregarFilasTabla(String id_trans){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                cantidades[pst].setText(redondearNumero(cursor.getDouble(cursor.getColumnIndex(IVKardex.FIELD_cantidad)),"0.00"));
    ...
    public void onBackPressed() {
        Intent intent = new Intent(OfertaDetalleM.this, MainActivity.class);
