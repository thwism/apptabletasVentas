package ibzssoft.com.ishidamovile.oferta.visualizar;
...
public class OfertaDetalleG extends AppCompatActivity {
    private TextView fe,he,bod,trans,precio,vendedor,cedula,nombres,direccion,telefono,mail,cli_obs,atencion, te, vl, fp,obs,subtotal_12,subtotal_0,subtotal_total,total_iva,total_trans,fm,estado,alterno,referenciaTittle,referencia;
    ...
    private TextView [] descripciones,cantidades,precios,descuentos,solicitado,totales;
    ...
    /*Datos adicionales*/
    private TextView info_cli_ruc,info_cli_nombres,info_cli_comercial,info_cli_direccion,info_cli_telefono;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oferta_detalleg);
    ...
    public void cargarPreferencias(){
        ExtraerConfiguraciones ext = new ExtraerConfiguraciones(OfertaDetalleG.this);
    ...
    public void inicializarComponentes(){
        impuestos="";conf_observacion=false;decimales=0;
        ...
        cli_id  = "";
        atencion= (TextView)findViewById(R.id.infoTransAT);
        te= (TextView)findViewById(R.id.infoTransTE);
        vl= (TextView)findViewById(R.id.infoTransVL);
        fp= (TextView)findViewById(R.id.infoTransFP);
        ...
        contenedorAdicionales=(CardView)findViewById(R.id.infoTransAdicionales);
        ...
        cantidades=new TextView[LIMITE];descripciones=new TextView[LIMITE];descuentos=new TextView[LIMITE];solicitado=new TextView[LIMITE];totales=new TextView[LIMITE];precios=new TextView[LIMITE];iva=new int[LIMITE];
        ...
        info_cli_ruc= (TextView) findViewById(R.id.info_cli_ruc);
        info_cli_nombres= (TextView) findViewById(R.id.info_cli_nombres);
        info_cli_comercial= (TextView) findViewById(R.id.info_cli_comercial);
        info_cli_direccion= (TextView) findViewById(R.id.info_cli_direccion);
        info_cli_telefono= (TextView) findViewById(R.id.info_cli_telefono);
    ...
    public void cargarObservaciones(String datos){
        ...
        try{
                ...
                if(data[1].isEmpty()!=true) atencion.setText(data[1]);
                if(data[2].isEmpty()!=true) te.setText(data[2]);
                if(data[3].isEmpty()!=true) vl.setText(data[3]);
                if(data[4].isEmpty()!=true) fp.setText(data[4]);
                if(data[5].isEmpty()!=true) info_cli_ruc.setText(data[5]);
                if(data[6].isEmpty()!=true) info_cli_nombres.setText(data[6]);
                if(data[7].isEmpty()!=true) info_cli_comercial.setText(data[7]);
                if(data[8].isEmpty()!=true) info_cli_direccion.setText(data[8]);
                if(data[9].isEmpty()!=true) info_cli_telefono.setText(data[9]);
    ...
    public void agregarFilasTabla(String id_trans){
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                if(cursor.getString(cursor.getColumnIndex(IVKardex.FIELD_padre_id))!=null && !cursor.getString(cursor.getColumnIndex(IVKardex.FIELD_padre_id)).equals("0")){
                ...
                precios[pst].setText(redondearNumero(cursor.getDouble(cursor.getColumnIndex(IVKardex.FIELD_pre_real_total))));
                ...
                solicitado[pst]= new TextView(this);
                solicitado[pst].setFocusable(false);
                solicitado[pst].setTextSize(14);
                solicitado[pst].setEnabled(false);
                solicitado[pst].setTextColor(getResources().getColor(R.color.textColorPrimary));
                solicitado[pst].setLayoutParams(layoutCeldas);
                solicitado[pst].setGravity(Gravity.CENTER);
                solicitado[pst].setPadding(5, 5, 5, 5);
                solicitado[pst].setText(cursor.getString(cursor.getColumnIndex(IVKardex.FIELD_desc_sol)));
...
//                fila.setPadding(5, 5, 5, 5);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(OfertaDetalleG.this, MainActivity.class);
