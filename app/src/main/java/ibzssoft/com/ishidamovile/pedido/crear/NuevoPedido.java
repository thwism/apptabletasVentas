...
public class NuevoPedido extends AppCompatActivity implements View.OnClickListener {
    /*
     ...
     */
        ...
        AutoCompleteClienteSelected adapter = new AutoCompleteClienteSelected(NuevoPedido.this);
...
/*Auto text Adapter*/
    ...
    public void crearDialogPrecios(final String[] valores, final String[] indices, final int fila) {
        LayoutInflater li = LayoutInflater.from(NuevoPedido.this);
        ...
        ListadoPreciosAdapter adapter = new ListadoPreciosAdapter(NuevoPedido.this, valores, indices);
    ...
    public void generarReporteCartera(String cliente) {
        ...
        ListadoCarteraAdaptador adapter = new ListadoCarteraAdaptador(NuevoPedido.this, R.layout.fila_cartera_cliente, cursor, from, to);
...
//                } else guardarTransaccion();
    ...
    /*
         ...
         */
    public void reload() {
        Intent intent = new Intent(NuevoPedido.this, NuevoPedido.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(NuevoPedido.this, MainActivity.class);
        intent.putExtra("opcion", getIntent().getIntExtra("opcion", 0));
        startActivity(intent);
        finish();
    }
