...
import ibzssoft.com.modelo.DetalleCierre;

public class CierreVentas extends AppCompatActivity implements
        ...
        DatePickerDialog.OnDateSetListener
{
    ...
    private String url;
    private String ws;
    private ArrayList<DetalleCierre> items = new ArrayList<DetalleCierre>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cierre_ventas);
    ...
    public void cargarPreferenciasConexion(){
        ExtraerConfiguraciones extraerConfiguraciones= new ExtraerConfiguraciones(CierreVentas.this);
        ...
        ws=extraerConfiguraciones.get(getString(R.string.key_ws_cierreventas),getString(R.string.pref_ws_cierreventas));
    }
    //cargar fechas por defecto
    public void loadDates(){
        date2.setText(new ParseDates().changeDateToStringSimple1(new Date()));
        date1.setText(new ParseDates().changeDateToStringSimple1(new Date()));
    }
    ...
    public void agregarFilasTabla(ArrayList<DetalleCierre> detalles){
        encerarArreglos();
        int pst=0;
        TableRow fila;
        if(!detalles.isEmpty()){
            do{
                ...
                descripciones[pst].setText(detalles.get(pst).getCliente());
                ...
                cant[pst].setText(String.valueOf(detalles.get(pst).getCodTrans()));
                ...
                transacciones[pst].setText(detalles.get(pst).getNumTrans());
                ...
                fechas[pst].setText(detalles.get(pst).getCodForma());
                ...
                can_total[pst].setText(String.valueOf(detalles.get(pst).getNombreForma()));
                ...
                precios[pst].setText(String.valueOf(detalles.get(pst).getValor()));
    ...
    private class RecibirInfoCierreTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = new ProgressDialog(CierreVentas.this);
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                for (int i = 0; i < respJSON.length(); i++) {
                    ...
                    DetalleCierre per = gson.fromJson(obj.toString(), DetalleCierre.class);
                    items.add(per);
        ...
        protected void onPostExecute(Boolean s) {
            if (progress.isShowing()) {
                ...
                if(s){
                    ...
                    Toast ts = Toast.makeText(CierreVentas.this, "No se puede descargar el historial", Toast.LENGTH_LONG);
                    ts.show();
                }
            }
        }
