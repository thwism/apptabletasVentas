package ibzssoft.com.ishidamovile.transbodega.visualizar;
...
public class TransferenciaDetalle extends AppCompatActivity {
    private TextView fe,he,bod,trans,precio,vendedor,obs,fm,estado,referenciaTittle,referencia,origen,destino;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transferencia_detalle);
    ...
    public void cargarPreferencias(){
        ExtraerConfiguraciones ext = new ExtraerConfiguraciones(TransferenciaDetalle.this);
    ...
    public void inicializarComponentes(){
        ...
        origen= (TextView)findViewById(R.id.infoTransOrigen);
        destino= (TextView)findViewById(R.id.infoTransDestino);
    ...
    public void cargarObservaciones(String datos){
        ...
        try{
            ...
            if(data[10].isEmpty()!=true){
                DBSistemaGestion helper = new DBSistemaGestion(TransferenciaDetalle.this);
                Cursor cursor = helper.consultarBodega(data[10]);
                if(cursor.moveToFirst()){
                    origen.setText(data[10]+":"+cursor.getString(cursor.getColumnIndex(Bodega.FIELD_nombre)));
                }
                cursor.close();
            }
            if(data[11].isEmpty()!=true){
                DBSistemaGestion helper = new DBSistemaGestion(TransferenciaDetalle.this);
                Cursor cursor = helper.consultarBodega(data[11]);
                if(cursor.moveToFirst()){
                    destino.setText(data[11]+":"+cursor.getString(cursor.getColumnIndex(Bodega.FIELD_nombre)));
                }
                cursor.close();
            }
        }catch(Exception e){
...
//                fila.setPadding(5, 5, 5, 5);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(TransferenciaDetalle.this, MainActivity.class);
