 ...
 */
public class RecibirCarteraRutas {
    ...
    private String url;
    private String ws;
    public RecibirCarteraRutas(Context context) {
    ...
    public void cargarPreferenciasConexion(){
        ...
        ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_cartera_ruta),context.getString(R.string.pref_ws_cartera_ruta));
        rutas=extraerConfiguraciones.get(context.getString(R.string.key_act_rut),context.getString(R.string.pref_act_rut_default)).split(",");
    }
    ...
    private class RecibirClientesTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progress.setTitle("Descargando Cartera por Rutas");
        ...
        protected Boolean doInBackground(String... params) {
            ...
            for(int i=0;i<rutas.length;i++){
                ...
                System.out.println("solicitando cartera ruta: "+"http://"+ip+":"+port+url+ws+"/"+rutas[i]);
                httpClient.getParams().setParameter("http.protocol.content-charset", HTTP.UTF_8);
                //Se agrega un campo adicional que es la clave para desencriptar informacion 22/04/2020
                HttpGet del = new HttpGet("http://"+ip+":"+port+url+ws+"/"+rutas[i]+"/"+CONST.CLAVE_DESENCRIPTAR);
