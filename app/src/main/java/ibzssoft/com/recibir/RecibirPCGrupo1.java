...
public class RecibirPCGrupo1 {
    ...
    public RecibirPCGrupo1(Context context) {
    ...
    public void cargarPreferenciasConexion(){
        ...
        ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_pcg1),context.getString(R.string.pref_ws_pcg1));
    ...
    public void ejecutartarea(){
        RecibirPCGrupo1sTask taskRecibirPCGrupo1s= new RecibirPCGrupo1sTask();
        taskRecibirPCGrupo1s.execute();
    }

    private class RecibirPCGrupo1sTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progress.setTitle("Descargando PCGrupo 1");
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try
            {
                ...
                for(int i=0; i<respJSON.length(); i++)
                {
                    ...
                    PCGrupo1 per=gson.fromJson(obj.toString(), PCGrupo1.class);
                    if (helper.existePCGrupo1(per.getCodgrupo1())){
                        helper.modificarPCGrupo1(per);
                    } else helper.crearPCGrupo1(per);
                    System.out.println("PCGrpo1 recibido: "+per.toString());
                    count++;
        ...
        protected void onPostExecute(Boolean s) {
            if(progress.isShowing()){
                progress.dismiss();
                if(s){
                    RecibirPCGrupo2 recibirPCGrupo2 = new RecibirPCGrupo2(context);
                    recibirPCGrupo2.ejecutartarea();
                }
            }
        }
    }
