...
public class RecibirIVGrupo5 {
    ...
    public RecibirIVGrupo5(Context context) {
    ...
    public void cargarPreferenciasConexion(){
        ...
        ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_ivg5),context.getString(R.string.pref_ws_ivg5));
    ...
    public void ejecutartarea(){
        RecibirIVGrupo5sTask taskRecibirIVGrupo5s= new RecibirIVGrupo5sTask();
        taskRecibirIVGrupo5s.execute();
    }

    private class RecibirIVGrupo5sTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progress.setTitle("Descargando Grupo 5");
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try
            {
                ...
                for(int i=0; i<respJSON.length(); i++)
                {
                    ...
                    IVGrupo5 cli=gson.fromJson(obj.toString(), IVGrupo5.class);
                    count++;
                    if(helper.existeIVGrupo5(cli.getIdgrupo5())){
                        helper.modificarIVGrupo5(cli);
                    }else{
                        helper.crearIVGrupo5(cli);
                    }
                    System.out.println("IVGrupo5 recibido: "+cli.toString());
        ...
        protected void onPostExecute(Boolean s) {
            if(progress.isShowing()){
                progress.dismiss();
                if(s){
                    RecibirIVGrupo6 recibirIVGrupo6 = new RecibirIVGrupo6(context);
                    recibirIVGrupo6.ejecutartarea();
                }
            }
        }
    }
