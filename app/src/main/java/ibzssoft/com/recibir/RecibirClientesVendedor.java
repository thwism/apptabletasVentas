 ...
 */
public class RecibirClientesVendedor {
    ...
    public RecibirClientesVendedor(Context context) {
    ...
    public void cargarPreferenciasConexion(){
        ...
        ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_clientes_vendedor),context.getString(R.string.pref_ws_clientes_vendedor));
    ...
    private class RecibirClientesTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progress.setTitle("Descargando Clientes por Vendedor");
