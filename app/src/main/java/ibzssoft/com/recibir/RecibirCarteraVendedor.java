 ...
 */
public class RecibirCarteraVendedor {
    ...
    private String url;
    private String ws;
    public RecibirCarteraVendedor(Context context) {
    ...
    public void cargarPreferenciasConexion(){
        ...
        ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_cartera_vendedor),context.getString(R.string.pref_ws_cartera_vendedor));
    ...
    private class RecibirClientesTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            ...
            progress.setTitle("Descargando Cartera por Vendedor");
        ...
        protected Boolean doInBackground(String... params) {
            ...
            for(int i=0;i<accesos.length;i++){
                ...
                System.out.println("solicitando cartera: "+"http://"+ip+":"+port+url+ws+"/"+accesos[i]);
