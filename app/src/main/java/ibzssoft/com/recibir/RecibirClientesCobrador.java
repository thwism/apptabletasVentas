...
*/
public class RecibirClientesCobrador {
   ...
   public RecibirClientesCobrador(Context context) {
   ...
   public void cargarPreferenciasConexion(){
       ...
       ws=extraerConfiguraciones.get(context.getString(R.string.key_ws_clientes_cobrador),context.getString(R.string.pref_ws_clientes_cobrador));
   ...
   private class RecibirClientesTask extends AsyncTask<String,Integer,Boolean> {
       ...
       protected void onPreExecute() {
           ...
           progress.setTitle("Descargando Clientes por Cobrador");
...
//                           System.out.println("Cliente recibido: "+cli.toString());
                       }
                       result=true;
                   }
                   catch(Exception ex)
