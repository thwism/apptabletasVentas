...
import ibzssoft.com.ishidamovile.ipt.modificar.ModificaIngresoProductoTerminado;
import ibzssoft.com.ishidamovile.ipt.visualizar.IngresoProductoTermiandoDetalle;
import ibzssoft.com.ishidamovile.transbodega.modificar.ModificaTransferencia;
import ibzssoft.com.ishidamovile.transbodega.visualizar.TransferenciaDetalle;
 ...
 */
public class TransIngProTermAdapter extends RecyclerView.Adapter<TransIngProTermAdapter.ViewHolderIngProtermA> {
    ...
    public TransIngProTermAdapter(Context context, List<Transaccion> models, int opcion) {
    ...
    @Override
    public ViewHolderIngProtermA onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = mInflater.inflate(R.layout.fila_transaccion_transferencia, parent, false);
        return new ViewHolderIngProtermA(itemView,context);
    }


    @Override
    public void onBindViewHolder(ViewHolderIngProtermA holder, int position) {
     ...
     */
    public class ViewHolderIngProtermA extends RecyclerView.ViewHolder  implements View.OnClickListener, View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener{
        private int nro;
        ...
        public ViewHolderIngProtermA(View view, Context context) {
            super(view);
        ...
        public void bind(Transaccion model) {
            ...
            cli_text.setText(model.getDescripcion().split(";")[0]);
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()){
                ...
                case R.id.itemallVer:
                    Intent intent1 = new Intent(activity, IngresoProductoTermiandoDetalle.class);
                ...
                case R.id.itemallModificar:
                    Intent intent2 = new Intent(activity, ModificaIngresoProductoTerminado.class);
