 ...
 */
public class TransTransferenciaBodegaAdapter extends RecyclerView.Adapter<TransTransferenciaBodegaAdapter.ViewHolderTransferenciaBodegaA> {
    ...
    public TransTransferenciaBodegaAdapter(Context context, List<Transaccion> models, int opcion) {
    ...
    @Override
    public ViewHolderTransferenciaBodegaA onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = mInflater.inflate(R.layout.fila_transaccion_transferencia, parent, false);
        return new ViewHolderTransferenciaBodegaA(itemView,context);
    }


    @Override
    public void onBindViewHolder(ViewHolderTransferenciaBodegaA holder, int position) {
     ...
     */
    public class ViewHolderTransferenciaBodegaA extends RecyclerView.ViewHolder  implements View.OnClickListener, View.OnCreateContextMenuListener,MenuItem.OnMenuItemClickListener{
        private int nro;
        ...
        public ViewHolderTransferenciaBodegaA(View view, Context context) {
            super(view);
        ...
        public boolean onMenuItemClick(MenuItem item) {
            ...
            switch (item.getItemId()){
                ...
                case R.id.itemallVer:
                    Intent intent1 = new Intent(activity, TransferenciaDetalle.class);
                ...
                case R.id.itemallModificar:
                    Intent intent2 = new Intent(activity, ModificaTransferencia.class);
