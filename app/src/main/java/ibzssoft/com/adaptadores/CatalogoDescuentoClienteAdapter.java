 ...
 */
public class CatalogoDescuentoClienteAdapter extends RecyclerView.Adapter<ViewHolderDescuento> {

    private final List<Descuento> mModels;
    private final LayoutInflater mInflater;
    private Context context;

    public CatalogoDescuentoClienteAdapter(Context context, List<Descuento> models) {
    ...
    public ViewHolderDescuento onCreateViewHolder(ViewGroup parent, int viewType) {
        final View itemView = mInflater.inflate(R.layout.fila_descuento_cliente, parent, false);
