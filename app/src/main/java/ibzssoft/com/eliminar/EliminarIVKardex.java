...
public class EliminarIVKardex {
    ...
    public EliminarIVKardex(Context context, String id_trans, int num_trans, String cod_trans, int position) {
    ...
    class EliminarDetallesTransaccionTask extends AsyncTask<Void,Integer,Boolean> {
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if(progress.isShowing()){
                progress.dismiss();
                if(aBoolean){
                    EliminarPCKardex asyncTask= new EliminarPCKardex(context,id_trans,num_trans,cod_trans,position);
